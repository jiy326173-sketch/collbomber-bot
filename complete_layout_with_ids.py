...
# COMPLETE LAYOUT WITH ALL IDS
xml = '''<?xml version="1.0" encoding="utf-8"?>
<FrameLayout xmlns:android="http://schemas.android.com/apk/res/android"
    android:layout_width="match_parent"
    android:layout_height="match_parent">

    <ImageView android:id="@+id/bgAnimation" android:layout_width="match_parent"
        android:layout_height="match_parent" android:src="@drawable/bg_home"
        android:scaleType="centerCrop" android:alpha="0.85" />
    <View android:layout_width="match_parent" android:layout_height="match_parent"
        android:background="@drawable/bg_gradient" />
    <ImageView android:id="@+id/lightSweep" android:layout_width="2400dp"
        android:layout_height="2dp" android:src="@drawable/light_sweep_bg"
        android:translationX="-1200dp" android:alpha="0.4" android:translationY="120dp" />
    ...
    <ScrollView android:layout_width="match_parent" android:layout_height="match_parent"
        ...
        <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
            ...
            <LinearLayout android:layout_width="wrap_content" android:layout_height="wrap_content"
                android:layout_gravity="end" android:background="@drawable/badge_premium"
                android:paddingHorizontal="14dp" android:paddingVertical="8dp" android:layout_marginBottom="12dp">
                ...
                <LinearLayout android:layout_width="wrap_content" android:layout_height="wrap_content"
                    ...
                    <TextView android:layout_width="wrap_content" android:layout_height="wrap_content"
                        android:text="Unlimited Access" android:textColor="#B0FFFFFF" android:textSize="8sp" />
                </LinearLayout>
            </LinearLayout>
                ...
                <FrameLayout android:layout_width="match_parent" android:layout_height="200dp"
                    ...
                    <FrameLayout android:layout_width="100dp" android:layout_height="100dp"
                        ...
                        <TextView android:layout_width="wrap_content" android:layout_height="wrap_content"
                            ...
                            android:textSize="11sp" android:textStyle="bold" android:gravity="center"
                            android:layout_gravity="center" />
                    </FrameLayout>
                    <LinearLayout android:id="@+id/tabCallBtn" android:layout_width="80dp"
                        android:layout_height="80dp" android:layout_gravity="top|start"
                        android:layout_marginStart="12dp" android:layout_marginTop="10dp"
                        android:orientation="vertical" android:gravity="center"
                        android:background="@drawable/qa_card" android:clickable="true"
                        android:focusable="true" android:elevation="2dp">
                        <ImageView android:layout_width="22dp" android:layout_height="22dp"
                            android:src="@drawable/ic_phone" android:scaleType="centerInside" />
                        <TextView android:layout_width="wrap_content" android:layout_height="wrap_content"
                            android:text="CALL" android:textColor="@color/white"
                            android:textSize="9sp" android:textStyle="bold" android:layout_marginTop="6dp" />
                    </LinearLayout>
                    <LinearLayout android:id="@+id/tabSmsBtn" android:layout_width="80dp"
                        android:layout_height="80dp" android:layout_gravity="top|end"
                        android:layout_marginEnd="12dp" android:layout_marginTop="10dp"
                        android:orientation="vertical" android:gravity="center"
                        android:background="@drawable/qa_card" android:clickable="true"
                        android:focusable="true" android:elevation="2dp">
                        <ImageView android:layout_width="22dp" android:layout_height="22dp"
                    ...
                    <LinearLayout android:id="@+id/tabWaBtn" android:layout_width="80dp"
                        android:layout_height="80dp" android:layout_gravity="bottom|start"
                        android:layout_marginStart="12dp" android:layout_marginBottom="10dp"
                        android:orientation="vertical" android:gravity="center"
                        android:background="@drawable/qa_card" android:clickable="true"
                        android:focusable="true" android:elevation="2dp">
                        <ImageView android:layout_width="22dp" android:layout_height="22dp"
                    ...
                    <LinearLayout android:id="@+id/tabMixBtn" android:layout_width="80dp"
                        android:layout_height="80dp" android:layout_gravity="bottom|end"
            ...
            <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                ...
                <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                    ...
                    <TextView android:id="@+id/tvLiveIndicator" android:layout_width="wrap_content"
                        ...
                        android:textColor="@color/status_success" android:textSize="11sp" android:textStyle="bold" />
                </LinearLayout>
                <ScrollView android:id="@+id/logScroll" android:layout_width="match_parent"
                    android:layout_height="80dp" android:layout_marginTop="10dp" android:scrollbars="none">
                    <TextView android:id="@+id/tvLog" android:layout_width="match_parent"
                        android:layout_height="wrap_content" android:text=""
                        android:textColor="@color/text_quaternary" android:textSize="9sp"
    ...
    <LinearLayout android:id="@+id/bottomNav" android:layout_width="match_parent"
        ...
        <LinearLayout android:id="@+id/tabMix" android:layout_width="0dp" android:layout_height="match_parent"
            ...
            <TextView android:id="@+id/labelMix" android:layout_width="wrap_content"
                ...
                android:textSize="10sp" android:textStyle="bold" android:layout_marginTop="4dp" />
...
print("Uploading COMPLETE layout with ALL IDs...")
upload(f"{LAYOUT}/activity_main.xml", xml)

# Verify all IDs
ids_to_check = ['bgAnimation', 'lightSweep', 'mixSection', 'etMixPhone', 'tvMixTotal', 'tvMixSuccess', 'tvMixFailed', 'btnMixStart', 'btnMixStop', 'tvLog', 'logScroll', 'tvLiveIndicator', 'callSection', 'etCallPhone', 'tvCallStats', 'btnCallStart', 'btnCallStop', 'smsSection', 'etSmsPhone', 'tvSmsStats', 'btnSmsStart', 'btnSmsStop', 'whatsappSection', 'etWaPhone', 'tvWaStats', 'btnWaStart', 'btnWaStop', 'bottomNav', 'tabMix', 'tabCall', 'tabSms', 'tabWa', 'iconMix', 'iconCall', 'iconSms', 'iconWa', 'labelMix', 'labelCall', 'labelSms', 'labelWa', 'indicatorMix', 'indicatorCall', 'indicatorSms', 'indicatorWa', 'tabCallBtn', 'tabSmsBtn', 'tabWaBtn', 'tabMixBtn', 'ivLogo', 'avatarRingGlow']
missing = [i for i in ids_to_check if i not in xml]
print(f"\nMissing IDs: {missing if missing else 'NONE - ALL PRESENT!'}")

v = subprocess.run(['shizuku', 'sh', '-c', f"wc -c '{LAYOUT}/activity_main.xml'"], capture_output=True, text=True, timeout=10)
print(f"File size: {v.stdout.strip() or v.stderr.strip()}")

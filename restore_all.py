...
def upload(path, content):
    ...
    subprocess.run(['shizuku', 'sh', '-c', f"rm -f '{path}'"], capture_output=True, timeout=20)
...
print("1. colors.xml restored")

# ===== RESTORE NIGHT COLORS =====
...
print("2. night/colors.xml restored")
...
print("3. themes.xml restored")

# ===== RESTORE NIGHT THEMES =====
...
print("4. night/themes.xml restored")
...
print("5. bg_gradient.xml restored")
